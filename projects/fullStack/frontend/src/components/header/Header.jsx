      ...
      <div className="container-fluid">
        ...
        <div className={`collapse navbar-collapse justify-content-end ${isOpen ? 'show' : ''}`}>
          <ul className="navbar-nav ">
            ...
            {
              loginStatus &&
              <li className="nav-item text-center d-flex flex-row align-content-center justify-content-center">
                <div className='d-flex flex-row align-content-center justify-content-center text-center flex-wrap'>
                  <Link to='./edituser' className='text-light m-0  text-decoration-none'>{currUser.username} <MdEdit/></Link>
                </div>
              </li>
            }
          </ul>
